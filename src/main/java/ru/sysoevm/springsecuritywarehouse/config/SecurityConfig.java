...
import ru.sysoevm.springsecuritywarehouse.model.Permission;
import ru.sysoevm.springsecuritywarehouse.model.Role;
...
public class SecurityConfig  extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/auth/category-create").hasAuthority(Permission.USERS_WRITE.getPermission())
                ...
                .defaultSuccessUrl("/auth/categories")
                .and()
                .logout()
